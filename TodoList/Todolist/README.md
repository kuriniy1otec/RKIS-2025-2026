...
- AppInfo - статический класс для хранения Todos и Profile
- Больше не нужно передавать параметры в команды

**Система отмены:**
- `undo` - отменить последнее действие
- `redo` - повторить отмененное действие
- Поддерживаются команды: add, delete, update, status

**Стеки команд:**
- UndoStack - выполненные команды
- RedoStack - отмененные команды
- Автоматическое сохранение в стеки

**Особенности:**
- При новом действии redo стек очищается
- Только изменяющие команды сохраняются в undo
- Просмотровые команды не сохраняются
